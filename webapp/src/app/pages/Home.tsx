  ...
  return (
    <main className="mx-auto max-w-2xl p-8 font-sans">
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5 text-slate-700">
        <li>
          Åpne <a className="underline" href="/api/status">/api/status</a>. Det
          er en rute som svarer JSON i stedet for HTML.
        </li>
        <li>Endre teksten i src/app/pages/Home.tsx og se at siden oppdaterer seg.</li>
